...
static const char *altbarcmd        = "$HOME/workspace/personal/debian-desktop/polybar/launch.sh"; /* alternate bar launch command */
...
static const char col_blue[]        = "#0A84FF";
...
static const char *dmenucmd[] = { "dmenu_run", "-i", "-m", dmenumon, "-fn", dmenufont, "-p", "  ", NULL };
...
static const char *screenshotcmd[] = { "flameshot", "gui", "--clipboard", NULL };
