...
# 2K/高密度 LCD 使用 RGB 子像素与完整 hinting，避免字体边缘发灰。
font_pattern='JetBrains Mono:pixelsize=16:antialias=true:autohint=false:hinting=true:hintstyle=hintfull:rgba=rgb:lcdfilter=lcddefault'
